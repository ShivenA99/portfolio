...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} antialiased`} style={{ backgroundColor: '#030712' }}>
      <body className="min-h-screen font-sans" style={{ backgroundColor: '#030712', color: '#e5e7eb' }}>
        {children}
      </body>
    </html>
  );
