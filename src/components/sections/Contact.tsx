    ...
    <section id="contact" className="py-24 relative" ref={ref}>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-emerald to-mint rounded-full mx-auto mb-6" />
          ...
          {contactCards.map((card, idx) => {
            ...
            return (
              ...
              >
                <Wrapper
                  {...wrapperProps}
                  className="glass glass-hover rounded-2xl p-5 flex items-center gap-4 transition-all duration-300 block"
                >
        ...
        >
          <a
            href={`mailto:${personalInfo.email}`}
            className="inline-flex items-center gap-2 px-6 py-3 bg-emerald text-white rounded-full font-medium text-sm hover:bg-emerald/90 transition-colors"
          >
            <Mail size={16} />
            Say Hello
          </a>
