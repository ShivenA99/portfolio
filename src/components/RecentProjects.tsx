  ...
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">
        A selection of{" "}
        <span className="text-emerald">recent projects</span>
      </h1>
              ...
              <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10">
                ...
                >
                  <div className="w-full h-full" style={{
                    background: `linear-gradient(135deg, ${item.accent}15 0%, #0D1117 50%, ${item.accent}10 100%)`
                  }} />
                </div>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {item.iconLists.map((tech, index) => (
                    ...
                    >
                      <span className="text-[10px] lg:text-xs text-white-100 font-medium">
                        {tech}
                      </span>
                    </div>
                  ))}
                ...
                <div className="flex justify-center items-center">
                  <p className="flex lg:text-xl md:text-xs text-sm text-emerald">
                    {item.linkLabel || "View"}
                  </p>
